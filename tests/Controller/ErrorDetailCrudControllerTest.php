 ...
 * @internal
 */
#[CoversClass(ErrorDetailCrudController::class)]
#[RunTestsInSeparateProcesses]
class ErrorDetailCrudControllerTest extends AbstractReadOnlyEasyAdminControllerTestCase
{
    protected function getControllerService(): ErrorDetailCrudController
    {
